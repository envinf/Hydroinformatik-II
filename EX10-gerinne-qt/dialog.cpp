    ...
    : QDialog(parent)
{
  ...
  label_ogs->setPixmap(QPixmap("../EX10-gerinne-qt/ogs_teaching_150.png"));
  QLabel *label_exercise = new QLabel();
  label_exercise->setAlignment(Qt::AlignCenter);
  label_exercise->setPixmap(QPixmap("../EX10-gerinne-qt/bhywi-08-08_title.png"));
  QLabel *label_channel = new QLabel();
  label_channel->setAlignment(Qt::AlignCenter);
  label_channel->setPixmap(QPixmap("../EX10-gerinne-qt/gerinne.png"));
  //push buttons
